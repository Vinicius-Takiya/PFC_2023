# Generated by Django 4.2.5 on 2023-10-09 07:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Aprovado', 'Aprovado'), ('Reprovado', 'Reprovado'), ('Aguardando Análise', 'Aguardando Análise')], default='Aguardando Análise', max_length=20)),
        ...
        migrations.AddField(
            model_name='orders',
            name='files',
            field=models.ManyToManyField(related_name='orders', through='api.OrdersFile', to='api.uploadedfile'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
